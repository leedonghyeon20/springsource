...
public class MartRepositoryTest {
    ...
    public void testCategoryItemInsert1() {
        ...
        Item item2 = Item.builder().name("콩나물").price(1200).stockQuantity(15).build();
        itemRepository.save(item2);

        categoryItem = CategoryItem.builder().category(category2).item(item2).build();
        categoryItemRepository.save(categoryItem);

        Item item3 = Item.builder().name("샴푸").price(12000).stockQuantity(15).build();
        itemRepository.save(item3);

        categoryItem = CategoryItem.builder().category(category3).item(item3).build();
        categoryItemRepository.save(categoryItem);
    }
