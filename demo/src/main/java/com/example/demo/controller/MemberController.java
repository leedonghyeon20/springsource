...
public class MemberController {
    ...
    @GetMapping("/register")
    public void getMethodName(@ModelAttribute("mDto") MemberDTO memberDTO) {
        log.info("회원가입");
    }

    @PostMapping("/register")
    public String postMethodName(@ModelAttribute("mDto") @Valid MemberDTO memberDTO, BindingResult result,
